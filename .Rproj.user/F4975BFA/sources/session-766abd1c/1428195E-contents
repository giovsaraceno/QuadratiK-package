...
#' @param alternative family of alternative chosen for selecting h, between "mean", "scale" and "skewness".
...
#' @param n_cores number of cores used to parallel the h selection algorithm (default:4).
