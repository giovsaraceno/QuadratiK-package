...
The `QuadratiK` package is also available in Python on PyPI and as a Dashboard application (ADD LINK HERE).
...
@Manual{saraceno2024QuadratiK, 
   ...
   year = {2024}, 
   note = {<https://cran.r-project.org/package=QuadratiK>,       <https://github.com/giovsaraceno/QuadratiK-package>,       <https://giovsaraceno.github.io/QuadratiK-package/>} 
}
```
...
# - scatter plot of data points on the sphereù
