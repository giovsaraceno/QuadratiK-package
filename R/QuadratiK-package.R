...
#' @description It is implemented in R and Python, providing a comprehensive set of goodness-of-fit tests and clustering technique using kernel-based quadratic distances. This framework aims to bridge the gap between the statistical and machine learning literature. It includes:
#' \itemize{
...
#' }
#' 
#' @details The work has been supported by Kaleida Health Foundation, National Science Foundation and Department of Biostatistics, University at Buffalo.
#' 
